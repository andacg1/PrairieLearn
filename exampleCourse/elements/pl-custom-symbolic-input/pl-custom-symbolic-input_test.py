...
symbolic_input = importlib.import_module("pl-custom-symbolic-input")
...
def test_parse_without_variables_attribute_with_assumptions() -> None:
    ...
    where using pl-custom-symbolic-input without a variables attribute would fail with
    ...
    element_html = '<pl-custom-symbolic-input answers-name="test"></pl-custom-symbolic-input>'
